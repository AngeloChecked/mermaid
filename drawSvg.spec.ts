...
describe("graph construction", () => {
  ...
  test("svg size", () => {
    ...
    const config = new Configuration(500, 500, fakeFont, () => 0, () => 0, { rx: 0, ry: 0 }, { horizontal: 0, vertical: 0 })
  ...
  test("node size", () => {
   ...
   { fontSize, fontFamily, fontWeight},
    ...
    expect(d3.select(ellipses[0]).attr("rx")).toBe(((ellipseSize.rx  + calculateTextWidth(nodeId)) / 2).toString())
  ...
  test("distribute nodes in the plane", () => {
    ...
    const config = new Configuration(500, 500, fakeFont, ((text?: string): number =>  0), (_) => 15, { rx: 50, ry: 10 }, { horizontal: 0, vertical: 0 })
  ...
  test("position a link in the plane", () => {
    const svg = d3.create("svg")
    const links = [
      { source: { id: "CustomerSelfServiceContext", boxText: undefined, bodyText: undefined }, target: { id: "PrintingContext", boxText: undefined, bodyText: undefined }, middleText: "Shared Kernel" }
    ]
    const nodes = [
      { "id": "CustomerSelfServiceContext" },
      { "id": "PrintingContext" },
    ...
    const config = new Configuration(500, 500, fakeFont, ((text?: string): number => text?.length ?? 0), (_) => 15, { rx: 50, ry: 10 }, { horizontal: 0, vertical: 0 })
  ...
  test("distribute 4 nodes in the plane considering margins", () => {
    ...
    ContextMapNode.disposeNodesInThePlane(nodes, { width: 400, height: 800 }, { horizontal: 10, vertical: 10 })
  ...
  test("crete link between two nodes", () => {
    ...
    const links = [
      { source: { id: "A", boxText: undefined, bodyText: undefined }, target: { id: "B", boxText: undefined, bodyText: undefined }, middleText: undefined },
      { source: { id: "A", boxText: undefined, bodyText: undefined }, target: { id: "C", boxText: undefined, bodyText: undefined }, middleText: undefined }
    ]
